...
public class ParserTest {
    ...
    public void testParser() throws IOException {
        ...
        assertEquals(40.7579765, firstTrip.getPickupCoord().getLatitude(), 0.0000001);
        assertEquals(-73.97816467, firstTrip.getPickupCoord().getLongitude(), 0.0000001);
        assertEquals(40.75117111, firstTrip.getDropoffCoord().getLatitude(), 0.0000001);
        assertEquals(-73.989837646, firstTrip.getDropoffCoord().getLongitude(), 0.0000001);
